...
from dpk_resize.spark.runtime import ResizeSparkTransformConfiguration
...
class TestRayResizeTransform(AbstractTransformLauncherTest):
    ...
    def get_test_transform_fixtures(self) -> list[tuple]:
        ...
        common_config = {"runtime_parallelization": 1}  # to make the output files repeatable.
        fixtures = []
        basedir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../test-data"))
        launcher = SparkTransformLauncher(ResizeSparkTransformConfiguration())
