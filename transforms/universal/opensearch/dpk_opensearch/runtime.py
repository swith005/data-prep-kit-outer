...
class OpenSearchPythonTransformConfiguration(PythonTransformRuntimeConfiguration):
    ...
    def __init__(self):
        ...
        """
        super().__init__(transform_config=OpenSearchTransformConfiguration())


class OpenSearch(Transform):
    def __init__(self, **kwargs):
        super().__init__(OpenSearchTransformConfiguration(), **kwargs)


if __name__ == "__main__":
    launcher = PythonTransformLauncher(OpenSearchPythonTransformConfiguration())
