...
from dpk_tokenization2arrow.ray.runtime import Tokenization2ArrowRayConfiguration
...
class TestRayTokenizationTransform(AbstractTransformLauncherTest):
    ...
    def get_test_transform_fixtures(self) -> list[tuple]:
        ...
        fixtures = [(launcher, tkn_params, basedir + "/tkn2arrow-ds01/input", basedir + "/tkn2arrow-ds01/expected")]
        return fixtures
