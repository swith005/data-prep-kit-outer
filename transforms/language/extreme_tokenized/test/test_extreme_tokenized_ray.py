...
from dpk_extreme_tokenized.ray.runtime import ExtremeTokenizedRayTransformConfiguration


class TestExtremeTokenizedRayTransform(AbstractTransformLauncherTest):
    """
