...
task_image = "quay.io/dataprep1/data-prep-kit/ml_filter-ray:latest"

# the name of the job script
EXEC_SCRIPT_NAME: str = "-m dpk_ml_filter.ray.runtime"
...
def ml_filter(
    # Ray cluster
    ray_name: str = "ml_filter-kfp-ray",  # name of Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'test/ml_filter/input/', 'output_folder': 'test/ml_filter/output/'}",
    ...
    ml_filter_config: str = "/home/ray/cleansing-config.yaml",
    ml_filter_ignore_missing_columns: bool = False,
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5, "delete_cluster_delay_minutes": 0}',
):
    """
    Pipeline to execute ml_filter transform
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(ml_filter, __file__.replace(".py", ".yaml"))
