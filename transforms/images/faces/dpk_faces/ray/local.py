...
from dpk_faces.ray.runtime import FacesRayTransformConfiguration

# create parameters
# When we have real test data we should switch to this
input_folder = os.path.abspath(os.path.join(os.path.dirname(__file__),
                                            "../../../../../data-processing-lib/python/src/data_processing/multimodal/ray", "..", "test-data", "input"))
...
params = {
    ...
    "faces_model_path": os.path.abspath(os.path.join(os.path.dirname(__file__),
                                                     "../../../../../data-processing-lib/python/src/data_processing/multimodal/ray", "..", "models", "yolov8n-face.pt"))
}
