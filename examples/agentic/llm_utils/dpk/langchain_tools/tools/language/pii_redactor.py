...
class PIIRedactorTransform(BaseTool):  # type: ignore[override, override]
    """Tool that apples pii_redactor transform."""

    name: str = "pii_redactor"
    args_schema: Type[BaseModel] = PIIRedactorInput
    description: str = "Apply PIIRedactor transform on files in input folder"
